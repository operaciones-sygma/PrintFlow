...
// PRINTFLOW v10.8.0 — Planificador de Producción (Gerardo)
      ...
      <div style={{display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 8, alignContent: "flex-start"}}>
        {visibleMachines.map(machine => {
          ...
          return <div key={machine.id}
            ...
            <div style={{marginBottom: 8, paddingBottom: 6, borderBottom: "0.5px solid " + C.bd}}>
              <div style={{fontSize: 12, fontWeight: 700, color: mColor}}>{machine.name}</div>
