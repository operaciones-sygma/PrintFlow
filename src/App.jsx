...
export default function PrintFlow() {
  ...
  const doAdv=useCallback(async(id,ns)=>{
    ...
    if(ns==="proof_client"){await db.notify("preprensa",id,"new_order","📤 Prueba enviada al cliente, esperando aprobación — "+(o?.client||"")+" · "+(o?.product_type||""),null,user);await db.notifySecs(id,"new_order","📤 Prueba enviada al cliente, esperando aprobación — "+(o?.client||"")+" · "+(o?.product_type||""),null,user,o?.created_by)}
