...
const getStale=o=>{if(o.stage.includes("delivered")||o.stage.includes("cancelled")||WAIT_STAGES.includes(o.stage))return null;const last=o.timeline?.length>0?o.timeline[o.timeline.length-1].date:o.created_at;const h=hoursAgo(last);if(h>=48)return{lv:"critical",lb:Math.floor(h/24)+"d estancada"};if(h>=24)return{lv:"warning",lb:h+"h sin avance"};return null};
