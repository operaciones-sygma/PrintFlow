...
// PRINTFLOW v10.10.0 — Órdenes de Compra (Lupita, Karla, Vendedor, Admin)
...
function OCard({o,role,onAction,compact,busy,noDragHint,userLogin}) {
  ...
  return <div draggable={isDraggable} onDragStart={e=>e.dataTransfer.setData("orderId",o.id)}
    ...
    {!compact&&!canAct&&!o.stage.includes("delivered")&&!o.stage.includes("cancelled")&&!o.invoice_folio&&isSec(role)&&secOwns&&<div onClick={e=>e.stopPropagation()} style={{marginTop:6,display:"flex",justifyContent:"flex-end"}}><button onClick={()=>onAction(o.id,"cancel_order")} style={bs(C.sf,C.dn)} title="Cancelar orden">❌ Cancelar</button></div>}
