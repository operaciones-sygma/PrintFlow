...
function OCard({o,role,onAction,compact,busy,noDragHint,userLogin}) {
  ...
  const secOwns=!isSec(role)||!o.created_by||o.created_by===userLogin;const canAct=secOwns&&(st?.who===role||(st?.who==="secretaria"&&isSec(role))||st?.who==="both"&&(role==="produccion"||role==="preprensa")||role==="admin"||(o.stage==="proof_client"&&isSec(role)));const stale=getStale(o);const hp=role==="produccion"||role==="preprensa"||role==="german";
